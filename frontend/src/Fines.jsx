    ...
    <div style={styles.content}>
      ...
      <div style={{ display: "flex", gap: "20px", marginBottom: "20px", flexWrap: "wrap" }}>
        <div style={{ ...styles.formBox, flex: 1 }}>
          ...
          <form onSubmit={handlePay} style={{ display: "flex", gap: "10px", flexWrap: "wrap", alignItems: "flex-end" }}>
            <div style={styles.formGroup}>
              ...
              <input style={styles.input} placeholder="Fine ID" value={payForm.fine_id} onChange={(e) => setPayForm({ ...payForm, fine_id: e.target.value })} required />
            </div>
            <div style={styles.formGroup}>
              <label style={styles.label}>Amount *</label>
              <input style={styles.input} placeholder="Amount" type="number" value={payForm.paid_amount} onChange={(e) => setPayForm({ ...payForm, paid_amount: e.target.value })} required />
            </div>
        ...
        <div style={{ ...styles.formBox, flex: 1 }}>
          ...
          <form onSubmit={handleWaive} style={{ display: "flex", gap: "10px", flexWrap: "wrap", alignItems: "flex-end" }}>
            <div style={styles.formGroup}>
              <label style={styles.label}>Fine ID *</label>
              <input style={styles.input} placeholder="Fine ID" value={waiveForm.fine_id} onChange={(e) => setWaiveForm({ ...waiveForm, fine_id: e.target.value })} required />
            </div>
            <div style={styles.formGroup}>
              <label style={styles.label}>Reason *</label>
              <input style={styles.input} placeholder="Reason" value={waiveForm.reason} onChange={(e) => setWaiveForm({ ...waiveForm, reason: e.target.value })} required />
            </div>
      ...
      {[
        ...
        <div key={title} style={styles.tableBox}>
          ...
          {data.length === 0 ? (
            <p style={{ color: "#999", textAlign: "center", padding: "20px" }}>No records!</p>
          ) : (
